...
export default function NextSection() {
  ...
  return (
    <section id="about" className="min-h-screen bg-gradient-to-br from-white to-gray-50 flex items-center">
            ...
            <div className={`transition-all duration-1000 ease-out delay-900 ${
              ...
              <div className="grid grid-cols-2 gap-6 mt-8">
                <div className="space-y-2">
                  ...
                  <h3 className="text-lg font-semibold text-gray-900">Casino Games</h3>
                  <p className="text-sm text-gray-600">Premium gaming experience</p>
                </div>
                <div className="space-y-2">
                  <div className="w-3 h-3 bg-[#27B9FC] rounded-full"></div>
                  <h3 className="text-lg font-semibold text-gray-900">Rice Farming</h3>
                  <p className="text-sm text-gray-600">Sustainable yield generation</p>
                </div>
                <div className="space-y-2">
                  <div className="w-3 h-3 bg-[#27B9FC] rounded-full"></div>
                  <h3 className="text-lg font-semibold text-gray-900">Staking Rewards</h3>
                  <p className="text-sm text-gray-600">Passive income opportunities</p>
                </div>
                <div className="space-y-2">
                  <div className="w-3 h-3 bg-[#27B9FC] rounded-full"></div>
                  <h3 className="text-lg font-semibold text-gray-900">Burnonomics</h3>
                  <p className="text-sm text-gray-600">Deflationary tokenomics</p>
                </div>
              </div>
            </div>
