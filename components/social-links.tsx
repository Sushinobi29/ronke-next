    ...
    <section className="py-20 bg-gradient-to-b from-black via-gray-900 to-black">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-[#27B9FC] mb-4">
            Connect with Ronke
          </h2>
          <p className="text-xl text-gray-300 max-w-2xl mx-auto">
            Join the Blue Monke community across all platforms
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-7 gap-6 max-w-5xl mx-auto">
          {socialLinks.map((social, index) => (
            ...
            >
              <div 
                className={`
                  relative overflow-hidden rounded-2xl p-6 transition-all duration-300 ease-out
                  ${hoveredLink === social.name ? 'transform scale-110' : 'transform scale-100'}
              ...
              >
                ...
                <div 
                  ...
                  `}
                  style={{
                    background: `radial-gradient(circle at 50% 50%, ${social.color}40, transparent 70%)`
                  }}
                />
                ...
                <div className="relative z-10 flex flex-col items-center space-y-3">
                  <div 
                    ...
                    style={{ 
                      color: hoveredLink === social.name ? social.color : '#9CA3AF' 
                    }}
                  >
                    {social.icon}
                  </div>
